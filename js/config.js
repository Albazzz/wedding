...
window.WEDDING_CONFIG = {
  ...
  guestbook: {
    ...
    /** Overlay full màn sau khi bấm ⛶ nếu đang dọc */
    wallRotateHint: {
      vi: "Đã phóng toàn màn hình — xoay ngang điện thoại để xem bầu trời lời chúc",
      en: "Fullscreen ready — rotate landscape to view the sky of wishes",
    },
    /** Chữ glow giữa orbit */
